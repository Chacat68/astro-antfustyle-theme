...
description: 'Notes on redesigning the blog with the fuwari theme: Vercel deploy, migrating projects/friends/list styles, and using an AI IDE along the way.'
