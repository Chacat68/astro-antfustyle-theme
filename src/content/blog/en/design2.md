...
### Understanding the Purpose of an Asset Library
...
During the collection phase, it's best to use tools that support all platforms, with web versions being ideal. I recommend websites like [Pinterest](https://www.pinterest.com/) and [Huaban](https://huaban.com/) as the first choice for asset collection.
...
- Pinterest requires a VPN for access, and Huaban may be temporarily unavailable due to policy changes. These are risks to be aware of and mitigate.
...
- Use Eagle's batch import feature to save materials grouped in Pinterest or Huaban in bulk to your desired cloud storage. Similar techniques can be applied to collect other types of assets in bulk.
