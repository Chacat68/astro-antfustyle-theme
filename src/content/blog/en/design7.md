...
description: 'Methods and steps for building an inspiration library using Eagle, including techniques for material collection, organization, and search, as well as an…'
...
[Eagle Official Website](https://eagle.cool/)
...
It is recommended to search for materials on websites like [Pinterest](https://www.pinterest.com/) or [Huaban](https://huaban.com/). These platforms typically have recommendation algorithms for images. After collecting a certain type of material, it's easy to find other similar materials based on the site's algorithm recommendations.

For example: The "More Ideas" feature on [Pinterest](https://www.pinterest.com/)
...
1. **Saving Board Images**: This imports all icons from a board into Eagle, creating a folder named after the board.

![](https://blog-1259751088.cos.ap-shanghai.myqcloud.com/20250102190543663.png?imageSlim)

2. **Batch Collecting**: This imports all images on the current page into Eagle. You can select the images you want to import. By default, they are imported into Eagle's "All" category and require further organization.
...
> 💡 Thank you for reading! Feel free to share the article or reach out to discuss.
